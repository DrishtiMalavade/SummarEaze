...
# Register the transcript routes
from transcript import transcript_blueprint
app.register_blueprint(transcript_blueprint)
...
def get_summary():
    ...
    try:
        ...
        prompt = """You are a YouTube video summarizer tasked with analyzing a transcript and creating a comprehensive summary. 
                    ...
                    Highlight the primary points discussed in the video in a structured manner. Do not make use of asterisks. just dont use asterisks at all and have it in paragraph format please
